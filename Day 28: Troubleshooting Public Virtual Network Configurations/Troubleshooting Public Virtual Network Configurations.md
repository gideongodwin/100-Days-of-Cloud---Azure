...
3. Select the NSG resource, and then under Settings, select Inbound security rules > Add.
...
4. In the resource group, select the public IP address resource
...
5. Under Settings, select IP configurations, and then associate the public IP address with the network interface of the virtual machine
